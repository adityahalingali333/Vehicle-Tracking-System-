...
<li><a href="<?php echo '../../route1/display_bus_route.php'; ?>"><i class='bx bx-analyse'></i>Stop Details</a></li>
<li><a href="<?php echo '../../routes/order_stops.php'; ?>"><i class='bx bx-analyse'></i>Order stops</a></li>
<li><a href="<?php echo '../../routes/index.php'; ?>"><i class='bx bx-analyse'></i>Display Ordered Stops</a></li>
...
?>
<a href="../../route1/display.php"> click to display routes</a>
</span>
                </li>
                ...
                <li><i class='bx bx-folder-minus'></i>
                    <span class="info">
                        <h3>
                        Insert Stop
                        </h3> <a href="../../route1/insert_bus_route.php"> click to add stop</a>                 
                    </span>
                </li>
